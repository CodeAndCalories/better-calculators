...
export const metadata: Metadata = {
  title: "Better Calculators — 250+ Free Online Calculators for Finance, Health & Life",
  description:
      ...
      <section className={styles.hero}>
        <div className={`container ${styles.heroInner}`}>
          ...
          <p className={styles.subheadline}>
            250+ Fast, accurate, beautifully designed calculators for finance, health, and life. No data collected. Just answers.
          </p>
          ...
          <div className={styles.stats}>
            <div className={styles.stat}><strong>250+</strong><span>Calculators</span></div>
