...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "About Better Calculators | Precision Tools",
    description: "Our mission is to provide accurate, transparent, and privacy-first calculation tools for finance, health, and everyday decisions.",
    url: "https://bettercalculators.net/about",
    siteName: "Better Calculators",
    images: [
      {
        url: 'https://bettercalculators.net/og-image.png', // Replace with your actual OG image path
        width: 1200,
        height: 630,
      },
    ],
  ...
  twitter: {
    ...
    description: 'Precision calculation tools for finance, health, and daily life.',
  },
};
